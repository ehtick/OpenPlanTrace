...
public sealed class SchemaContractTests
{
    ...
    public void PlacementSchema_DefinesDownstreamPlacementShapes()
    {
        ...
        AssertDefinitionRequires(schemaDocument, "summary", "pageCount", "mainFloorplanRegionCount", "surfacePatternCount", "wallCount", "structuralWallCount", "excludedWallCount", "placementReadyWallCount", "placementOmittedWallCount", "wallTopologySpanCount", "wallSolidSpanCount", "wallPlacementOmissionCounts", "roomCount", "openingCount", "anchoredOpeningCount", "unanchoredOpeningCount", "objectAggregateCount", "wallGraphRepairCandidateCount", "suppressedChildObjectCount", "routingBarrierCount", "routingPassageCount", "routingObstacleCount", "routingRoomUseHintCount", "routingSuppressedObjectCount", "routingItemCount", "totalPlacementEntityCount", "reliabilityTrackedEntityCount", "coordinateReadyEntityCount", "metricReadyEntityCount", "reviewRequiredEntityCount", "coordinateReadyRatio", "metricReadyRatio", "issueCount", "infoIssueCount", "warningIssueCount", "errorIssueCount", "sourcePrimitiveReferenceCount", "uniqueSourcePrimitiveReferenceCount", "importReadiness", "pageSummaries", "evidence");
        ...
        AssertDefinitionRequires(schemaDocument, "pageSummary", "pageNumber", "pageBounds", "mainFloorplanBounds", "detectionBounds", "detectionBoundsMillimeters", "surfacePatternCount", "wallCount", "structuralWallCount", "excludedWallCount", "placementReadyWallCount", "placementOmittedWallCount", "wallTopologySpanCount", "wallSolidSpanCount", "wallPlacementOmissionCounts", "roomCount", "openingCount", "anchoredOpeningCount", "unanchoredOpeningCount", "objectAggregateCount", "wallGraphRepairCandidateCount", "routingItemCount", "reliabilityTrackedEntityCount", "coordinateReadyEntityCount", "metricReadyEntityCount", "reviewRequiredEntityCount", "issueCount");
