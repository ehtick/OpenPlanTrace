...
public sealed class SchemaContractTests
{
    ...
    public async Task EmbeddedScanSchema_MatchesDocumentedSchemaArtifact()
    {
        ...
        Assert.Equal("urn:openplantrace:schema:scan:v72", document.RootElement.GetProperty("$id").GetString());
        Assert.Equal(
    ...
    public async Task EmbeddedPlacementSchema_MatchesDocumentedSchemaArtifact()
    {
        ...
        Assert.Equal("https://json-schema.org/draft/2020-12/schema", document.RootElement.GetProperty("$schema").GetString());
        Assert.Equal("urn:openplantrace:schema:placement:v12", document.RootElement.GetProperty("$id").GetString());
        Assert.Equal(
    ...
    public void PlacementSchema_DefinesDownstreamPlacementShapes()
    {
        ...
        AssertDefinitionRequires(schemaDocument, "room", "id", "pageNumber", "bounds", "center", "boundary", "wallIds", "drawingArea", "confidence", "boundaryReliability", "reliability", "evidence");
        AssertDefinitionRequires(schemaDocument, "roomBoundaryReliability", "boundaryWallCount", "assessedWallCount", "readyWallIds", "reviewWallIds", "rejectedWallIds", "nonBlockingDuplicateWallIds", "openingOnlyWallIds", "openingDominatedWallIds", "roomSupportedFragmentWallIds", "placementOmittedWallIds", "unassessedWallIds", "coordinateBlockingWallIds", "evidence");
        ...
        AssertDefinitionRequires(schemaDocument, "wallGraph", "summary", "nodes", "edges", "components", "repairCandidateIds", "residualEndpointOnHostCandidates", "evidence");
    ...
    public void ScanSchema_DefinesEvidenceBearingDetectorShapes()
    {
        ...
        AssertDefinitionRequires(schemaDocument, "wall", "id", "centerLine", "bounds", "detectionKind", "wallType", "wallComponentId", "wallComponentKind", "excludedFromStructuralTopology", "placementStatus", "representedByWallIds", "readyForCoordinatePlacement", "requiresReview", "reviewReasons", "lengthMeters", "thicknessMillimeters", "measurementScaleGroupId", "confidence", "sourcePrimitiveIds", "sourceLayers", "pairEvidence", "fragmentEvidence", "evidenceAssessment", "evidence");
        AssertDefinitionRequires(schemaDocument, "wallEvidenceInlineAssessment", "category", "confidence", "placementReady", "requiresReview", "rejectedAsNoise", "scoreBreakdown", "sourcePrimitiveIds", "evidence");
        AssertDefinitionRequires(schemaDocument, "wallEvidenceScoreBreakdown", "positiveScore", "negativeScore", "decisionScore", "pairSupportScore", "layerSupportScore", "structuralSupportScore", "recoverySupportScore", "noisePenalty", "fragmentReviewPenalty", "positiveEvidence", "negativeEvidence");
        ...
        AssertDefinitionRequires(schemaDocument, "curvedWall", "id", "pageNumber", "center", "startPoint", "endPoint", "centerlineRadius", "innerRadius", "outerRadius", "startAngleRadians", "sweepAngleRadians", "thickness", "drawingArcLength", "radiusMillimeters", "thicknessMillimeters", "arcLengthMeters", "measurementScaleGroupId", "bounds", "sourceRegionId", "sourceKind", "angularOverlapRatio", "radialFitError", "readyForCoordinatePlacement", "excludedFromLinearTopology", "confidence", "requiresReview", "sourcePrimitiveIds", "sourceLayers", "evidence");
        AssertDefinitionRequires(schemaDocument, "structuralPathTopology", "contractVersion", "paths", "junctions", "metrics", "evidence");
        AssertDefinitionRequires(schemaDocument, "structuralPath", "id", "pageNumber", "kind", "line", "circularArc", "startPoint", "endPoint", "bounds", "drawingLength", "lengthMeters", "thickness", "thicknessMillimeters", "measurementScaleGroupId", "wallType", "confidence", "readyForCoordinatePlacement", "requiresReview", "sourceRegionId", "connectedPathIds", "connectedStraightPathIds", "connectedStraightPathSupportCount", "sourceStructuralWallRunIds", "sourceCurvedWallCandidateIds", "sourceWallIds", "sourceWallGraphEdgeIds", "sourcePrimitiveIds", "sourceLayers", "evidence");
        AssertDefinitionRequires(schemaDocument, "structuralCircularArcPath", "center", "radius", "startAngleRadians", "sweepAngleRadians", "startPoint", "endPoint", "bounds", "drawingLength");
        AssertDefinitionRequires(schemaDocument, "structuralPathJunction", "id", "pageNumber", "kind", "firstEndpoint", "secondEndpoint", "proposedPosition", "endpointDistance", "matchTolerance", "directionAngleDegrees", "tangentDeviationDegrees", "confidence", "requiresReview", "sourcePrimitiveIds", "evidence");
        AssertDefinitionRequires(schemaDocument, "structuralPathTopologyMetrics", "linePathCount", "circularArcPathCount", "junctionCount", "tangentJunctionCount", "cornerJunctionCount", "connectedCurvedPathCount", "unconnectedCurvedPathCount", "rejectedCurvedCandidateCount", "placementReadyPathCount", "reviewPathCount");
        ...
        AssertDefinitionRequires(schemaDocument, "wallFragmentEvidence", "fragmentCount", "totalHealedGap", "maxHealedGap", "duplicatePrimitiveCount", "gapRatio", "requiresGeometryReview", "evidence");
        AssertDefinitionRequires(schemaDocument, "wallTopologySpan", "id", "wallGraphEdgeId", "sourceWallGraphEdgeIds", "pageNumber", "wallId", "fromNodeId", "toNodeId", "centerLine", "bounds", "drawingLength", "thickness", "confidence", "sourcePrimitiveIds", "sourceLayers", "evidence");
        AssertDefinitionRequires(schemaDocument, "wallEdge", "id", "pageNumber", "fromNodeId", "toNodeId", "wallId", "wallComponentId", "wallComponentKind", "excludedFromStructuralTopology", "readyForCoordinatePlacement", "requiresReview", "reviewReasons", "line", "lineMillimeters", "bounds", "boundsMillimeters", "drawingLength", "lengthMeters", "thicknessDrawingUnits", "thicknessMillimeters", "measurementScaleGroupId", "millimetersPerDrawingUnit", "confidence", "sourcePrimitiveIds", "sourceLayers", "evidence");
    ...
    public void DocumentedBatchResultSchema_DefinesVisualSnapshotSummaryContract()
    {
        ...
        Assert.True(
            schemaDocument.RootElement
                ...
                .GetProperty("properties")
                .TryGetProperty("coordinateReadyRatio", out _),
            "Batch import readiness schema should document coordinateReadyRatio.");
