...
public sealed class SchemaContractTests
{
    ...
    public void VisualSnapshotSchema_DefinesPageLayerBoundsAndIssueShapes()
    {
        ...
        AssertDefinitionRequires(schemaDocument, "wallPlacementSummary", "placementReadyWallCount", "placementOmittedWallCount", "representedWallCount", "placementSuppressedWallCount", "placementReviewWallCount", "omissionCounts", "topOmissions");
