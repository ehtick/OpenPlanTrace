...
public sealed class SchemaContractTests
{
    ...
    public async Task EmbeddedScanSchema_MatchesDocumentedSchemaArtifact()
    {
        ...
        Assert.Equal("urn:openplantrace:schema:scan:v70", document.RootElement.GetProperty("$id").GetString());
        Assert.Equal(
    ...
    public async Task EmbeddedPlacementSchema_MatchesDocumentedSchemaArtifact()
    {
        ...
        Assert.Equal("https://json-schema.org/draft/2020-12/schema", document.RootElement.GetProperty("$schema").GetString());
        Assert.Equal("urn:openplantrace:schema:placement:v9", document.RootElement.GetProperty("$id").GetString());
        Assert.Equal(
    ...
    public void PlacementSchema_DefinesDownstreamPlacementShapes()
    {
        ...
        AssertDefinitionRequires(schemaDocument, "roomBoundaryReliability", "boundaryWallCount", "assessedWallCount", "readyWallIds", "reviewWallIds", "rejectedWallIds", "nonBlockingDuplicateWallIds", "unassessedWallIds", "coordinateBlockingWallIds", "evidence");
