...
public static class WallPlacementReadinessEvaluator
{
    ...
    public const string RoomConfirmedIsolatedExteriorPromotionEvidence =
        "room-confirmed isolated exterior shell segment kept placement-ready";
    ...
    private const double MinTrustedMainStructuralExteriorPairLengthDrawingUnits = 96.0;
    private const double MinTrustedMainStructuralExteriorPairScore = 0.82;
    ...
    private const double MinTrustedRoomConfirmedIsolatedExteriorLengthDrawingUnits = 48.0;
    private const double MinTrustedRoomConfirmedIsolatedExteriorPairScore = 0.70;
    private const double MinTrustedRoomConfirmedIsolatedExteriorOverlapRatio = 0.95;
    private const double MinTrustedRoomConfirmedIsolatedExteriorFaceSeparationDrawingUnits = 1.5;
    ...
    private const double MinTrustedDimensionLikeExteriorPerimeterLengthDrawingUnits = 48.0;
    private const double MinTrustedDimensionLikeExteriorPerimeterPairScore = 0.72;
    private const double MinTrustedDimensionLikeExteriorPerimeterOverlapRatio = 0.98;
    private const double MinTrustedDimensionLikeExteriorPerimeterFaceSeparationDrawingUnits = 6.0;
    private const double MaxTrustedDimensionLikeExteriorPerimeterFaceSeparationDrawingUnits = 30.0;
    private const int MaxTrustedDimensionLikeExteriorPerimeterPairFaceFragments = 96;
    private const int MaxTrustedDimensionLikeExteriorPerimeterPairTotalFaceFragments = 150;
    private const double MinTrustedOpeningLinkedFilledInteriorLengthDrawingUnits = 60.0;
    private const double MinTrustedOpeningLinkedFilledInteriorPairScore = 0.90;
    private const double MinTrustedOpeningLinkedFilledInteriorOverlapRatio = 0.95;
    private const double MinTrustedOpeningLinkedFilledInteriorFaceSeparationDrawingUnits = 2.0;
    private const double MaxTrustedOpeningLinkedFilledInteriorFaceSeparationDrawingUnits = 16.0;
    private const int MaxTrustedOpeningLinkedFilledInteriorPairFaceFragments = 96;
    private const int MaxTrustedOpeningLinkedFilledInteriorPairTotalFaceFragments = 160;
    ...
    private const int MaxTrustedDenseTwoSidedFragmentMergedRoomBoundaryFragments = 48;
    private const int MaxTrustedDenseTwoSidedFragmentMergedRoomBoundaryDuplicateFragments = 12;
    private const double MinTrustedExteriorShellRepairPairLengthDrawingUnits = 42.0;
    private const double MinTrustedExteriorShellRepairPairScore = 0.60;
    private const double MinTrustedExteriorShellRepairPairOverlapRatio = 0.70;
    private const double MinTrustedExteriorShellRepairFaceSeparationDrawingUnits = 1.5;
    private const double MaxTrustedExteriorShellRepairFaceSeparationDrawingUnits = 30.0;
    private const int MaxTrustedExteriorShellRepairPairFaceFragments = 180;
    private const int MaxTrustedExteriorShellRepairPairTotalFaceFragments = 280;
    private const double MinTrustedExteriorShellRepairStrokeLengthDrawingUnits = 72.0;
    private const int MaxTrustedExteriorShellRepairStrokeFragments = 220;
    private const int MaxTrustedExteriorShellRepairStrokeDuplicatePrimitives = 72;
        ...
        IEnumerable<string>? reviewReasons = null)
    {
        ...
        var trustedExteriorShellContinuityFragment = IsTrustedExteriorShellContinuityFragment(
            ...
            component,
            evidenceAssessment);
        var trustedExteriorShellRepairSupportedWall = IsTrustedExteriorShellRepairSupportedWall(
            wall,
            component,
            evidenceAssessment);
        var trustedMainStructuralExteriorWallBody = IsTrustedMainStructuralExteriorWallBody(
            wall,
            component,
            evidenceAssessment);
        var trustedMainStructuralExteriorRecallWallBody = IsTrustedMainStructuralExteriorRecallWallBody(
            wall,
            component,
            evidenceAssessment);
        var trustedLongIsolatedExteriorShellWallBody = IsTrustedLongIsolatedExteriorShellWallBody(
            wall,
            component,
            evidenceAssessment);
        var trustedRoomBoundaryIsolatedFragment = IsTrustedRoomBoundaryIsolatedFragment(
            ...
            component,
            evidenceAssessment);
        var trustedRoomBoundaryIsolatedExteriorWall = IsTrustedRoomBoundaryIsolatedExteriorWall(
            wall,
            component,
            evidenceAssessment);
        var trustedDimensionLikeExteriorPerimeterWallBody = IsTrustedDimensionLikeExteriorPerimeterWallBody(
            wall,
            component,
            evidenceAssessment);
        var trustedOpeningLinkedFilledInteriorWallBody = IsTrustedOpeningLinkedFilledInteriorWallBody(
            wall,
            component,
            evidenceAssessment);
        var trustedRecoveredRoomBoundaryObjectLikeWall = IsTrustedRecoveredRoomBoundaryObjectLikeWall(
            wall,
            component,
            evidenceAssessment);
        ...
        if (component is not null)
        {
            AddComponentReasons(
                ...
                trustedIsolatedTwoSidedInteriorPair,
    ...
    private static void AddComponentReasons(
        ...
        bool trustedRoomBoundaryIsolatedExteriorWall,
        bool trustedDimensionLikeExteriorPerimeterWallBody,
        bool trustedOpeningLinkedFilledInteriorWallBody,
        ...
        bool trustedIsolatedTwoSidedInteriorPair,
    ...
    private static void AddEvidenceReasons(
        ...
        bool trustedMainStructuralExteriorRecallWallBody,
        bool trustedLongIsolatedExteriorShellWallBody,
        bool trustedRoomBoundaryIsolatedExteriorWall,
        bool trustedDimensionLikeExteriorPerimeterWallBody,
        bool trustedOpeningLinkedFilledInteriorWallBody,
    ...
    private static bool CoordinatePlacementBlockedByComponent(
        ...
        bool trustedIsolatedTwoSidedInteriorPair,
        bool trustedRecoveredRoomBoundaryObjectLikeWall) =>
        component?.ExcludedFromStructuralTopology == true && !trustedRecoveredRoomBoundaryObjectLikeWall && !trustedRoomBoundaryIsolatedExteriorWall && !trustedDimensionLikeExteriorPerimeterWallBody && !trustedOpeningLinkedFilledInteriorWallBody && !trustedObjectLikeLongCleanFragmentInterior && !trustedObjectLikeExteriorShellPair && !trustedRejectedStrongBoundaryWallBody && !trustedRejectedMediumBoundaryFragmentWallBody && !trustedRejectedObjectLikeBoundaryRecallWallBody && !trustedIsolatedTwoSidedInteriorPair && !trustedExteriorShellRepairSupportedWall && !trustedLongIsolatedExteriorShellWallBody
        ...
        WallEvidenceWallAssessment? evidenceAssessment)
    {
        ...
        var evidence = wall.Evidence
            ...
            .ToArray();
        var hasExteriorShellRepairSupport = EvidenceContains(evidence, "exterior shell repair support");
        if (wall.DrawingLength < MinTrustedExteriorShellContinuityLengthDrawingUnits
            && (!hasExteriorShellRepairSupport || wall.DrawingLength < 48.0))
        {
            return false;
        }
    ...
    public static bool IsTrustedExteriorShellRepairSupportedWall(
        WallSegment? wall,
        WallGraphComponent? component,
        WallEvidenceWallAssessment? evidenceAssessment)
    {
        if (wall is null
            ...
            || evidenceAssessment.Category is not (WallEvidenceCategory.StrongWallBody
                ...
                or WallEvidenceCategory.RecoveredWallBody)
            || wall.WallType != WallType.Exterior
            || ResolveOrientation(wall.CenterLine) == TrustedExteriorShellRepairOrientation.Unknown)
        {
            return false;
        }
        ...
        var evidence = wall.Evidence
            ...
            .ToArray();
        var hasExteriorShellSupport =
            EvidenceContains(evidence, "exterior shell repair support")
            || EvidenceContains(evidence, "inferred exterior shell wall");
        if (!hasExteriorShellSupport)
        {
            return false;
        }
        ...
        if (wall.PairEvidence is { } pair)
        {
            ...
            return wall.DrawingLength >= MinTrustedExteriorShellRepairPairLengthDrawingUnits
                && pair.Score >= MinTrustedExteriorShellRepairPairScore
                && pair.OverlapRatio >= MinTrustedExteriorShellRepairPairOverlapRatio
                && pair.FaceSeparation >= MinTrustedExteriorShellRepairFaceSeparationDrawingUnits
                && pair.FaceSeparation <= MaxTrustedExteriorShellRepairFaceSeparationDrawingUnits
                && maxFaceFragments <= MaxTrustedExteriorShellRepairPairFaceFragments
                && totalFaceFragments <= MaxTrustedExteriorShellRepairPairTotalFaceFragments;
        }

        if (wall.DetectionKind is not (WallDetectionKind.FragmentMerged or WallDetectionKind.SingleLine)
            || wall.DrawingLength < MinTrustedExteriorShellRepairStrokeLengthDrawingUnits)
        {
            return false;
        }
        ...
        {
            if (EvidenceContains(evidence, "inferred exterior shell wall"))
            {
                return true;
            }

            return EvidenceContains(evidence, "global-envelope-fragment-chain")
                || EvidenceContains(evidence, "global-room-envelope-edge");
        }

        return fragmentEvidence.FragmentCount <= MaxTrustedExteriorShellRepairStrokeFragments
            && fragmentEvidence.DuplicatePrimitiveCount <= MaxTrustedExteriorShellRepairStrokeDuplicatePrimitives
            && fragmentEvidence.GapRatio <= 0.45
            && fragmentEvidence.MaxHealedGap <= Math.Max(120.0, wall.DrawingLength * 0.45);
    }
    ...
    public static bool IsTrustedRoomBoundaryIsolatedExteriorWall(
        WallSegment? wall,
        WallGraphComponent? component,
        WallEvidenceWallAssessment? evidenceAssessment)
    {
    ...
    public static bool IsTrustedDimensionLikeExteriorPerimeterWallBody(
        WallSegment? wall,
        WallGraphComponent? component,
        WallEvidenceWallAssessment? evidenceAssessment)
    {
        if (wall is null
            ...
            || wall.DetectionKind != WallDetectionKind.ParallelLinePair
            || wall.PairEvidence is not { } pair
            || wall.DrawingLength < MinTrustedDimensionLikeExteriorPerimeterLengthDrawingUnits
            || wall.Confidence.Value < 0.78
        ...
        var maxFaceFragments = Math.Max(pair.FirstFaceFragmentCount, pair.SecondFaceFragmentCount);
        var totalFaceFragments = pair.FirstFaceFragmentCount + pair.SecondFaceFragmentCount;
        if (pair.Score < MinTrustedDimensionLikeExteriorPerimeterPairScore
            || pair.OverlapRatio < MinTrustedDimensionLikeExteriorPerimeterOverlapRatio
            || pair.FaceSeparation < MinTrustedDimensionLikeExteriorPerimeterFaceSeparationDrawingUnits
            || pair.FaceSeparation > MaxTrustedDimensionLikeExteriorPerimeterFaceSeparationDrawingUnits
    ...
    public static bool IsTrustedOpeningLinkedFilledInteriorWallBody(
        WallSegment? wall,
        WallGraphComponent? component,
        WallEvidenceWallAssessment? evidenceAssessment)
    {
        if (wall is null
            ...
            || wall.DetectionKind != WallDetectionKind.ParallelLinePair
            || wall.PairEvidence is not { } pair
            || wall.DrawingLength < MinTrustedOpeningLinkedFilledInteriorLengthDrawingUnits
            || wall.Confidence.Value < 0.86
            || evidenceAssessment.Confidence.Value < 0.86
            || evidenceAssessment.RejectedAsNoise
            || evidenceAssessment.Decision == WallEvidenceDecision.Reject
            || evidenceAssessment.Category is not (WallEvidenceCategory.StrongWallBody
                or WallEvidenceCategory.MediumWallBody))
        ...
        var maxFaceFragments = Math.Max(pair.FirstFaceFragmentCount, pair.SecondFaceFragmentCount);
        var totalFaceFragments = pair.FirstFaceFragmentCount + pair.SecondFaceFragmentCount;
        if (pair.Score < MinTrustedOpeningLinkedFilledInteriorPairScore
            || pair.OverlapRatio < MinTrustedOpeningLinkedFilledInteriorOverlapRatio
            || pair.FaceSeparation < MinTrustedOpeningLinkedFilledInteriorFaceSeparationDrawingUnits
            || pair.FaceSeparation > MaxTrustedOpeningLinkedFilledInteriorFaceSeparationDrawingUnits
            || maxFaceFragments > MaxTrustedOpeningLinkedFilledInteriorPairFaceFragments
            || totalFaceFragments > MaxTrustedOpeningLinkedFilledInteriorPairTotalFaceFragments)
        {
            return false;
        }
        ...
        if (!EvidenceContains(evidence, "opening-linked wall fragment")
            || !EvidenceContainsAny(evidence, "Window/", "(Window")
    ...
    public static bool IsTrustedRecoveredRoomBoundaryObjectLikeWall(
        WallSegment? wall,
        WallGraphComponent? component,
        WallEvidenceWallAssessment? evidenceAssessment)
    {
        ...
        var evidence = wall.Evidence
            ...
            .Concat(component.Evidence)
            .ToArray();
        if (!EvidenceContains(evidence, "rejected room-boundary candidate restored")
            || !EvidenceContains(evidence, "unsupported indoor room edge")
            || !EvidenceContains(evidence, "parallel wall-face pair"))
        {
            return false;
        }
        ...
        WallEvidenceWallAssessment? evidenceAssessment)
    {
        ...
        var denseTwoSidedRoomBoundary =
            fragmentCount <= MaxTrustedDenseTwoSidedFragmentMergedRoomBoundaryFragments
            && fragmentEvidence.DuplicatePrimitiveCount <= MaxTrustedDenseTwoSidedFragmentMergedRoomBoundaryDuplicateFragments
        ...
        if (fragmentCount < 2
            || (fragmentCount > MaxTrustedTwoSidedFragmentMergedRoomBoundaryFragments && !denseTwoSidedRoomBoundary)
            || (fragmentEvidence.DuplicatePrimitiveCount > MaxTrustedTwoSidedFragmentMergedRoomBoundaryDuplicateFragments && !denseTwoSidedRoomBoundary)
            || fragmentEvidence.GapRatio > 0.001
            || fragmentEvidence.TotalHealedGap > 0.001)
        {
            return false;
        ...
        return denseTwoSidedRoomBoundary
            || !EvidenceContains(evidence, "dimension-like");
    }
        ...
        WallEvidenceWallAssessment? evidenceAssessment)
    {
        ...
        return !ExteriorWallSupportEvidence.HasExplicitTrustedSupport(evidence);
    }
        ...
        WallEvidenceWallAssessment? evidenceAssessment)
    {
        ...
        var evidence = wall.Evidence
            ...
            .Concat(evidenceAssessment.ScoreBreakdown.NegativeEvidence)
            .ToArray();
        var hasExplicitlyUntrustedOutdoorEvidence = EvidenceContainsAny(
                evidence,
                "outdoor covered-area boundary",
                "unpaired outdoor covered-area boundary",
                "covered-area boundary",
        ...
        var hasContextOnlyOutdoorPromotion =
            wall.DetectionKind is WallDetectionKind.SingleLine or WallDetectionKind.FragmentMerged
            && wall.PairEvidence is null
            && evidenceAssessment.Category is WallEvidenceCategory.MediumWallBody
                or WallEvidenceCategory.RecoveredWallBody
                or WallEvidenceCategory.WeakSingleLine
            && EvidenceContains(
                evidence,
                "detected room evidence on one side is outdoor/terrace space");
        if (!hasExplicitlyUntrustedOutdoorEvidence && !hasContextOnlyOutdoorPromotion)
        {
            return false;
        }

        return !ExteriorWallSupportEvidence.HasTrustedSupport(
            wall,
            evidenceAssessment,
            evidence);
    }
        ...
        WallEvidenceWallAssessment? evidenceAssessment)
    {
        ...
        if (!EvidenceContains(evidence, TopologySupportedFragmentedPairPromotionEvidence)
            ...
            || HasTopologySupportedEndpointCount(evidence, minimumEndpointCount: 3))
        {
            return false;
        }
    ...
    private static int? TryReadEvidenceCount(string evidence, string marker)
    {
        ...
        return end > start
            && int.TryParse(evidence[start..end], System.Globalization.NumberStyles.Integer, System.Globalization.CultureInfo.InvariantCulture, out var count)
                ? count
                : null;
    }

    public static bool IsTrustedMainStructuralExteriorWallBody(
        WallSegment? wall,
        WallGraphComponent? component,
        WallEvidenceWallAssessment? evidenceAssessment)
    {
        if (wall is null
            ...
            || wall.DetectionKind != WallDetectionKind.ParallelLinePair
            || wall.PairEvidence is not { } pair
            || wall.DrawingLength < MinTrustedMainStructuralExteriorPairLengthDrawingUnits)
        {
            return false;
        }
    ...
    public static bool IsTrustedMainStructuralExteriorRecallWallBody(
        WallSegment? wall,
        WallGraphComponent? component,
        WallEvidenceWallAssessment? evidenceAssessment)
    {
        if (wall is null
            ...
            || evidenceAssessment.RejectedAsNoise
            || evidenceAssessment.Decision == WallEvidenceDecision.Reject
            || (evidenceAssessment.PlacementReady && !evidenceAssessment.RequiresReview)
            || evidenceAssessment.Category is not (WallEvidenceCategory.StrongWallBody
                or WallEvidenceCategory.MediumWallBody
                or WallEvidenceCategory.RecoveredWallBody)
            || wall.WallType != WallType.Exterior
            || wall.DetectionKind != WallDetectionKind.ParallelLinePair
            || wall.PairEvidence is not { } pair
            || wall.DrawingLength < MinTrustedMainStructuralExteriorRecallPairLengthDrawingUnits
        ...
        var maxFaceFragments = Math.Max(pair.FirstFaceFragmentCount, pair.SecondFaceFragmentCount);
        var totalFaceFragments = pair.FirstFaceFragmentCount + pair.SecondFaceFragmentCount;
        if (pair.Score < MinTrustedMainStructuralExteriorRecallPairScore
            || pair.OverlapRatio < MinTrustedMainStructuralExteriorRecallPairOverlapRatio
            || pair.FaceSeparation < MinTrustedMainStructuralExteriorRecallPairFaceSeparationDrawingUnits
            || pair.FaceSeparation > MaxTrustedRoomConfirmedIsolatedExteriorFaceSeparationDrawingUnits
            || maxFaceFragments > MaxTrustedMainStructuralExteriorRecallPairFaceFragments
            || totalFaceFragments > MaxTrustedMainStructuralExteriorRecallPairTotalFaceFragments)
        {
            return false;
        }
        ...
        var hasExteriorShellContext =
            ...
            || wall.SourcePrimitiveIds.Count >= 2;
        if (!hasExteriorShellContext)
        {
            return false;
        }
        ...
        WallEvidenceWallAssessment? evidenceAssessment)
    {
        if (wall is null
            ...
            || wall.DetectionKind != WallDetectionKind.ParallelLinePair
            || wall.PairEvidence is not { } pair
            || wall.DrawingLength < MinTrustedLongIsolatedExteriorShellLengthDrawingUnits)
        {
            return false;
        }
        ...
        var maxFaceFragments = Math.Max(pair.FirstFaceFragmentCount, pair.SecondFaceFragmentCount);
        var totalFaceFragments = pair.FirstFaceFragmentCount + pair.SecondFaceFragmentCount;
        if (pair.Score < MinTrustedLongIsolatedExteriorShellPairScore
            || pair.OverlapRatio < MinTrustedLongIsolatedExteriorShellOverlapRatio
            || pair.FaceSeparation < MinTrustedExteriorShellContinuityFaceSeparationDrawingUnits
            || pair.FaceSeparation > MaxTrustedExteriorShellContinuityFaceSeparationDrawingUnits
            || maxFaceFragments > MaxTrustedLongIsolatedExteriorShellFaceFragments
            || totalFaceFragments > MaxTrustedLongIsolatedExteriorShellTotalFaceFragments)
        {
            return false;
        }
        ...
        WallEvidenceWallAssessment? evidenceAssessment)
    {
        ...
        var evidence = wall.Evidence
            ...
            .Concat(evidenceAssessment.ScoreBreakdown.NegativeEvidence)
            .ToArray();
        if (ExteriorWallSupportEvidence.HasExplicitTrustedSupport(evidence))
        {
            return false;
        }
    ...
    private static TrustedExteriorShellRepairOrientation ResolveOrientation(PlanLineSegment line)
    {
        if (line.IsHorizontal(2))
        {
            return TrustedExteriorShellRepairOrientation.Horizontal;
        }

        return line.IsVertical(2)
            ? TrustedExteriorShellRepairOrientation.Vertical
            : TrustedExteriorShellRepairOrientation.Unknown;
    }
        ...
        bool trustedDenseTwoSidedRoomFragmentMergedInterior)
    {
        ...
        if (trustedTwoSidedFragmentMergedRoomBoundary
            && reason.Contains(
    ...
    private enum TrustedExteriorShellRepairOrientation
    {
        Unknown,
        Horizontal,
        Vertical
