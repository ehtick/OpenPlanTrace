...
fix counter. When `DEF` reaches `030`, the next major work cycle moves to the
...
- Fixed fragmented perimeter bands being promoted by weak room evidence.
- Improved independent wall-support diagnostics.
...
- Improved logical wall continuity through openings.
- Improved physical wall-run coalescing and junction reconnection.
- Fixed unsupported detail ticks being classified as windows.
- Improved nested fixture-cutout rejection.
...
- Preserved exact wall coordinates during semantic reconciliation.
- Improved exterior continuity without increasing canonical wall count.

## [0.11.025] - 2026-07-30

- Fixed ambiguous opening evidence promoting equipment details as walls.
- Improved isolated wall rejection without weakening valid two-room opening hosts.
- Updated structural evidence and solver contracts.

## [0.11.024] - 2026-07-30

- Improved source-backed wall-body junction normalization.
- Preserved opening gaps and already-connected wall endpoints.
- Improved extreme-tier exterior continuity without changing light or medium wall geometry.
...
- Fixed stale duplicate classifications that clipped valid wall extents.
- Improved canonical wall extent diagnostics and regression coverage.

## [0.11.021] - 2026-07-30

- Improved nested appliance and fixture-loop rejection.
- Improved duplicate wall-face consolidation.
- Improved exterior shell and wall-body reconciliation.
- Improved shared-source wall deduplication.
- Improved exterior and interior wall transitions.
- Updated wall solver contract versions.

## [0.11.020] - 2026-07-30

- Improved StructuralCore endpoint snapping at supported wall junctions.
- Improved wall connectivity without changing detected wall coverage.
- Improved regression coverage for semantic-free structural junctions.

## [0.11.019] - 2026-07-30

- Improved physical wall centerlines from shared PDF wall geometry.
- Improved resolved-wall stability against off-center source faces.
- Improved regression coverage for interior assemblies and source voting.

## [0.11.018] - 2026-07-30

- Improved recovery of room partitions shadowed by opposite walls.
- Extended partial filled wall bodies into complete canonical walls.
- Improved extreme-tier wall connectivity.
- Preserved light and medium canonical wall geometry.

## [0.11.017] - 2026-07-29

- Improved cross-domain recovery of continuous fragmented wall axes.
- Merged partial partition fallbacks into full canonical walls.
- Preserved dimension, repeated-detail, and outdoor boundary blockers.
- Preserved light and medium canonical wall geometry.
...
- Merged offset shell duplicates into filled wall bodies.
- Connected corrected exterior wall junctions.
- Reduced extreme-tier wall graph noise.
- Preserved light and medium wall geometry.
...
- Recovered complete room-separating walls over partial fallback fragments.
- Prevented fixture-sized room loops from promoting object lines.
- Improved structural solver decision diagnostics.
- Improved walls-only verification across all difficulty tiers.

## [0.11.012] - 2026-07-29

- Recovered solver-selected walls with review evidence.
- Preserved review-only walls for global recall.
- Recovered unanimous major walls with two anchored openings.
- Expanded local reviewed wall-recovery truth.
- Preserved explicit absolute wall rejection.
- Added structural decision regression coverage.

## [0.11.011] - 2026-07-29

- Improved orthogonal wall endpoint snapping.
- Prevented offset parallel endpoint merging.
- Removed post-solver wall skew.
- Preserved wall selection across test tiers.
...
- Small improvement to isolated-fragment visual tests.

## [0.09.013] - 2026-07-07

- Improved omitted-wall visual risk filtering.
- Small improvement to wall-QA noise tests.

## [0.09.012] - 2026-07-07

- Improved wall-QA focus visibility.
- Small improvement to excluded placement geometry tests.

## [0.09.011] - 2026-07-07

- Improved wall omission linked-wall cleanup.
- Small improvement to topology repair export tests.

## [0.09.010] - 2026-07-07

- Improved partial structural wall fallback recovery.
- Improved short exterior continuity wall placement.
- Small improvement to wall placement regression tests.

## [0.09.009] - 2026-07-06

- Improved dense main-structural wall retention.
- Improved source-backed exterior shell placement recovery.
- Improved wall-QA omitted-risk accuracy.
- Small improvement to wall accuracy regression tests.
...
- Improved omitted-wall review screenshots by hiding detail noise.
- Small improvement to omitted-risk export tests.

## [0.09.006] - 2026-07-03

- Improved wall-QA omitted-risk highlighting.
- Improved visual-snapshot coordinates for omitted wall review risks.
- Small improvement to wall-QA export tests.

## [0.09.005] - 2026-07-03

- Improved wall-evidence primitive reuse.
- Improved door-arc support checks during wall filtering.
- Small improvement to hard PDF scan performance.
...
- Improved long wall graph cleanup.
- Small improvement to source-backed exterior wall regression tests.
...
- Improved source-backed fallback placement for isolated wall pairs.
- Small improvement to isolated wall-pair regression tests.

## [0.09.000] - 2026-07-02

- Improved rejected object-like boundary wall recovery.
- Improved source-backed fallback span preservation.
- Improved wall-only benchmark screenshot review.
- Small improvement to object-like wall regression tests.

## [0.08.030] - 2026-07-02

- Improved outdoor-clipped shell closure filtering.
- Improved covered-area wall graph suppression.
- Small improvement to source-backed closure tests.

## [0.08.029] - 2026-07-02

- Improved protected bridge wall graph export.
- Improved placement graph and topology span agreement.
- Small improvement to bridge graph regression tests.

## [0.08.028] - 2026-07-02

- Improved inferred exterior shell run bridging.
- Improved weak dimension-layer bridge handling.
- Small improvement to exterior continuity tests.

## [0.08.027] - 2026-07-02

- Improved clean isolated room-boundary fragment recovery.
- Improved source-backed wall fallback evidence.
- Small improvement to isolated fragment recovery tests.

## [0.08.026] - 2026-07-02

- Improved short recovered room-boundary wall recovery.
- Improved source-backed review wall diagnostics.
- Small improvement to recovered wall fallback tests.

## [0.08.025] - 2026-07-02

- Improved rejected object-like wall recovery.
- Improved recovered wall graph run merging.
- Small improvement to recovered wall regression tests.

## [0.08.024] - 2026-07-02

- Improved short filled interior wall recovery.
- Improved dense door-area wall safeguards.
- Small improvement to wall fallback tests.

## [0.08.023] - 2026-07-02

- Improved opening-linked fragment wall recovery.
- Improved medium room-boundary fragment wall recovery.
- Small improvement to wall fallback regression tests.

## [0.08.022] - 2026-07-02

- Improved exterior wall recall thresholds.
- Improved visual snapshot wall omission examples.
- Small improvement to placement QA consistency tests.
...
- Small improvement to wall graph overrun tests.

## [0.08.019] - 2026-07-02

- Improved rejected wall-body recovery.
- Improved object-like fragment wall safeguards.
- Small improvement to wall readiness tests.

## [0.08.018] - 2026-07-02

- Improved long exterior wall recall.
- Improved dimension-like wall-body safeguards.
- Small improvement to wall fallback tests.
...
- Improved duplicate host wall diagnostics.
- Small improvement to placement issue export tests.

## [0.08.015] - 2026-07-02

- Improved residual wall endpoint snapping.
- Improved protected exterior shell wall evidence handling.
- Small improvement to wall graph export tests.

## [0.08.014] - 2026-07-02

- Improved weak exterior recall wall filtering.
- Improved dimension-like perimeter wall review safety.
- Small improvement to exterior recall export tests.

## [0.08.013] - 2026-07-02

- Improved protected exterior shell wall recovery.
- Improved object-like wall component placement safeguards.
- Small improvement to source-backed wall export tests.

## [0.08.012] - 2026-07-02

- Improved surface-pattern crossing wall readiness.
- Small improvement to wall overlap review tests.

## [0.08.011] - 2026-07-02

- Improved secondary thin exterior bridge readiness.
- Small improvement to exterior wall readiness tests.

## [0.08.010] - 2026-07-02

- Improved room-side short wall-return recovery.
- Small improvement to dense-detail wall protection tests.

## [0.08.009] - 2026-07-02

- Improved very short room-boundary wall recovery.
- Small improvement to dense-detail wall demotion tests.

## [0.08.008] - 2026-07-02

- Improved wall QA screenshots with compact import wall graph lines.
- Small improvement to wall QA legend and snapshot tests.

## [0.08.007] - 2026-07-01

- Improved non-blocking wall graph endpoint-gap reporting.
- Small improvement to placement issue regression tests.

## [0.08.006] - 2026-07-01

- Improved same-axis wall continuation merging.
- Small improvement to wall graph residual cleanup tests.

## [0.08.005] - 2026-07-01

- Improved paired wall-face placement alignment.
- Improved source parameter clamping after wall endpoint snaps.
- Small improvement to wall placement regression tests.

## [0.08.004] - 2026-07-01

- Improved short wall over-merge prevention.
- Small improvement to wall topology regression tests.

## [0.08.003] - 2026-07-01

- Improved opening-linked wall recovery.
- Small improvement to wall recovery regression tests.

## [0.08.002] - 2026-07-01

- Improved dimension-like exterior wall recovery.
- Small improvement to perimeter wall regression tests.

## [0.08.001] - 2026-07-01

- Improved exterior wall bridge merging.
- Small improvement to long wall topology tests.

## [0.08.000] - 2026-07-01

- Improved long exterior wall recall.
- Improved source-backed wall topology recovery.
- Small improvement to wall accuracy regression tests.

## [0.07.029] - 2026-06-30

- Improved dense structural wall recovery.
- Improved geometric isolated exterior shell placement.
- Small improvement to wall placement regression tests.

## [0.07.028] - 2026-06-30

- Improved continuous dense fragment wall recovery.
- Improved one-end structural fragment promotion safeguards.
- Small improvement to wall graph regression tests.

## [0.07.027] - 2026-06-30

- Improved trusted secondary paired-wall recovery near object linework.
- Improved object-overlap wall suppression safeguards.
- Small improvement to secondary wall regression tests.

## [0.07.026] - 2026-06-30

- Improved short geometric room-boundary fragment recovery.
- Improved source-backed spans for short two-sided wall fragments.
- Small improvement to wall fragment regression tests.

## [0.07.025] - 2026-06-30

- Improved long clean wall recovery from object-like components.
- Improved source-backed placement spans for protected wall fragments.
- Small improvement to wall export regression tests.

## [0.07.024] - 2026-06-30

- Improved continuous fragment wall recovery.
- Improved multi-source exterior bridge coordinate safety.
- Small improvement to represented wall QA comparisons.

## [0.07.023] - 2026-06-30

- Improved represented wall comparison signals.
- Improved batch wall consolidation reporting.
- Small improvement to comparison regression tests.

## [0.07.022] - 2026-06-30

- Improved dense room-backed wall fragment recovery.
- Improved source-backed exterior wall continuation merging.
- Small improvement to wall placement regression tests.
...
- Improved paired wall body-axis placement.
- Small improvement to placement export regression tests.

## [0.07.019] - 2026-06-30

- Improved long exterior wall recall.
- Improved dimension-like shell wall confidence.
- Small improvement to wall refinement regression tests.

## [0.07.018] - 2026-06-30

- Improved batch comparison readiness signals.
- Improved wall placement delta reporting.
- Small improvement to comparison regression tests.

## [0.07.017] - 2026-06-30

- Improved dense-detail wall recovery.
- Improved filled wall-body placement confidence.
- Small improvement to wall refinement regression tests.

## [0.07.016] - 2026-06-29

- Improved redundant exterior fallback cleanup.
- Improved source-backed duplicate wall suppression.
- Small improvement to wall representation regression tests.

## [0.07.015] - 2026-06-29

- Improved trusted interior wall span bridging.
- Improved opening-aware bridge safety.
- Small improvement to wall bridge regression tests.

## [0.07.014] - 2026-06-29

- Improved filled secondary wall recovery.
- Improved exterior bridge detail guards.
- Small improvement to wall placement regression tests.

## [0.07.013] - 2026-06-29

- Improved long secondary wall fragment recovery.
- Improved source-backed fallback safety checks.
- Small improvement to fragment fallback regression tests.

## [0.07.012] - 2026-06-29

- Improved secondary structural wall review issues.
- Improved likely missing wall diagnostics.
- Small improvement to placement issue regression tests.

## [0.07.011] - 2026-06-29

- Improved opening-like wall fragment cleanup.
- Improved placement graph node reduction.
- Small improvement to wall graph cleanup regression tests.

## [0.07.010] - 2026-06-29

- Improved placement graph QA source context.
- Improved wall screenshot render performance.
- Small improvement to SVG profile documentation.

## [0.07.009] - 2026-06-29

- Improved wall QA viewer graph rendering.
- Improved final placement graph compaction.
- Small improvement to placement graph cleanup diagnostics.

## [0.07.008] - 2026-06-29

- Improved room-boundary short exterior wall recovery.
- Improved placement graph residual endpoint cleanup.
- Small improvement to protected junction compaction tests.

## [0.07.007] - 2026-06-29

- Improved short recovered room-boundary wall recovery.
- Improved source-backed fallback evidence gating.
- Small improvement to missing short-wall regression tests.

## [0.07.006] - 2026-06-29

- Improved exterior continuation wall alignment.
- Improved dominant-axis snap safety guards.
- Small improvement to exterior wall placement regression tests.

## [0.07.005] - 2026-06-29

- Improved continuity-supported exterior wall recovery.
- Improved unsafe clean-projection fallback precision.
- Small improvement to terrace-adjacent wall regression tests.

## [0.07.004] - 2026-06-29

- Improved inferred exterior shell wall recovery.
- Improved source-backed wall fallback gating.
- Small improvement to exterior shell fallback regression tests.

## [0.07.003] - 2026-06-29

- Improved duplicate wall-body omission classification.
- Improved represented-wall review accounting.
- Small improvement to placement duplicate regression tests.

## [0.07.002] - 2026-06-29

- Improved short stair/detail wall suppression.
- Improved dimension-like dense-detail placement guards.
- Small improvement to wall refinement regression tests.

## [0.07.001] - 2026-06-29

- Improved filled exterior wall drift recovery.
- Improved unsafe clean-span fallback precision.
- Small improvement to wall recovery regression tests.

## [0.07.000] - 2026-06-29

- Improved synthetic exterior-shell and interior wall separation.
- Improved trusted interior wall visibility in placement output.
- Small improvement to duplicate-clean topology regression tests.

## [0.06.029] - 2026-06-29

- Improved source-backed interior wall fallback.
- Improved unsafe clean-projection wall recovery.
- Small improvement to dense room-boundary fallback tests.

## [0.06.028] - 2026-06-29

- Improved tiny contained wall-span cleanup.
- Improved placement wall graph compactness.
- Small improvement to duplicate topology tests.

## [0.06.027] - 2026-06-29

- Improved contained source-backed wall fallback cleanup.
- Improved filled exterior solid duplicate handling.
- Small improvement to wall topology regression tests.

## [0.06.026] - 2026-06-29

- Improved opening-owned wall topology splitting.
- Improved contained exterior wall-fragment cleanup.
- Small improvement to placement topology regression tests.

## [0.06.025] - 2026-06-26

- Improved exterior wall continuity across door cutouts.
- Improved placement span compactness for exported walls.
- Small improvement to opening cutout export tests.

## [0.06.024] - 2026-06-26

- Improved filled exterior wall recovery.
- Improved structural exterior wall review handling.
...
- Improved strict placement-ready wall screenshot profiles.
- Small improvement to SVG overlay export tests.

## [0.06.021] - 2026-06-26

- Improved source-backed exterior wall trimming near outdoor rooms.
- Improved covered-entry false exterior wall suppression.
- Small improvement to wall type refinement tests.

## [0.06.020] - 2026-06-26

- Improved covered outdoor boundary inference guards.
- Improved exterior shell recovery near outdoor rooms.
- Small improvement to wall type refinement tests.

## [0.06.019] - 2026-06-26

- Improved trusted exterior corner snapping.
- Improved placement wall graph endpoint alignment.
- Small improvement to exterior corner snap tests.

## [0.06.018] - 2026-06-26

- Improved tiny opening bridge cleanup in placement wall graphs.
- Improved wall graph node compactness for host-attached opening fragments.
- Small improvement to placement graph export tests.

## [0.06.017] - 2026-06-26

- Improved trusted isolated exterior wall typing.
- Improved same-source interior wall run cleanup.
- Small improvement to wall placement and type refinement tests.

## [0.06.016] - 2026-06-26

- Improved dense-detail room-boundary wall recovery.
- Improved main-structural side-room evidence handling.
- Small improvement to wall type refinement tests.

## [0.06.015] - 2026-06-26

- Improved room-supported short exterior wall recovery.
- Improved weak-host opening split cleanup.
- Small improvement to wall placement regression tests.
...
- Improved stacked wall-fragment node cleanup.
- Small improvement to wall graph alignment tests.

## [0.06.003] - 2026-06-25

- Improved residual wall endpoint snapping.
- Improved same-axis duplicate wall cleanup.
- Small improvement to wall graph cleanup tests.

## [0.06.002] - 2026-06-25

- Improved exterior wall graph rejoining across junction nodes.
- Improved nearby wall endpoint alignment.
- Improved post-snap wall graph compaction.
- Small improvement to wall graph cleanup tests.

## [0.06.001] - 2026-06-25

- Improved small residual wall endpoint snapping.
- Improved host wall alignment without splitting long runs.
- Small improvement to residual wall graph tests.

## [0.06.000] - 2026-06-25

- Improved long wall graph compaction after endpoint cleanup.
- Improved structured residual endpoint alignment candidates.
- Small improvement to placement graph junction tests.
...
- Small improvement to visual QA summary counts.

## [0.05.024] - 2026-06-25

- Improved trusted exterior shell repair export.
- Improved topology-blocked repair filtering.
- Small improvement to wall placement regression tests.

## [0.05.023] - 2026-06-25

- Improved final wall graph long-run compaction.
- Improved fuzzy exterior wall axis alignment.
- Small improvement to placement graph cleanup tests.

## [0.05.022] - 2026-06-25

- Improved placement wall graph axis straightening.
- Improved shared node snapping onto host wall axes.
- Improved trusted exterior shell gap compaction.
- Small improvement to placement graph cleanup tests.

## [0.05.021] - 2026-06-25

- Improved placement graph endpoint coordinate alignment.
- Improved source-backed fallback wall run merging.
- Small improvement to placement graph regression tests.
...
- Improved one-end fragment placement.
- Small improvement to fragment wall safety gates.

## [0.05.001] - 2026-06-24

- Improved noisy one-end wall recovery.
- Improved long fragment wall recovery.
- Small improvement to secondary wall source clutter.

## [0.05.000] - 2026-06-24

- Improved major wall recovery.
- Improved noisy vector wall placement.
- Small improvement to door-adjacent wall stubs.

## [0.04.001] - 2026-06-24

- Improved near-axis wall alignment.

## [0.04.000] - 2026-06-24

- Improved version cadence.

## [0.03.036] - 2026-06-24

- Improved geometric room-boundary evidence.
- Small improvement to dense detail wall filtering.

## [0.03.035] - 2026-06-24

- Improved short room-backed wall recovery.
- Small improvement to fragmented wall filtering.

## [0.03.034] - 2026-06-24

- Improved source-backed wall recovery.
- Small improvement to door-adjacent wall stubs.
...
- Small improvement to benchmark QA validation.

## [0.03.031] - 2026-06-23

- Improved clean-wall projection drift review.
- Small improvement to wall placement safety.

## [0.03.030] - 2026-06-23

- Improved covered-entry wall review.
- Improved outdoor boundary placement blocking.

## [0.03.029] - 2026-06-23

- Improved placement wall-set indexes.
- Improved clean wall import guidance.

## [0.03.028] - 2026-06-23

- Improved batch wall-placement QA summaries.
- Improved corpus wall-omission reporting.

## [0.03.027] - 2026-06-23

- Improved one-ended wall fragment review issues.
- Improved import-readiness review guidance.

## [0.03.026] - 2026-06-23

- Improved endpoint-fragment wall review labels.
- Improved placement omission clarity.

## [0.03.025] - 2026-06-23

- Improved review-only fallback wall blocking.
- Improved medium-plan clean wall accuracy.

## [0.03.024] - 2026-06-23

- Improved opening-linked wall fragment suppression.
- Improved hard-plan wall QA review clarity.

## [0.03.023] - 2026-06-23

- Improved door-adjacent wall noise suppression.
- Improved wall QA review clarity.

## [0.03.022] - 2026-06-23

- Improved structural-excluded wall suppression.
- Improved isolated-fragment wall QA clarity.

## [0.03.021] - 2026-06-23

- Improved repeated-detail wall suppression.
- Improved medium-plan wall QA clarity.

## [0.03.020] - 2026-06-23

- Improved opening-consumed wall suppression.
- Improved wall QA review noise cleanup.

## [0.03.019] - 2026-06-23

- Improved actionable wall review counts.
- Improved wall QA suppressed-noise summaries.

## [0.03.018] - 2026-06-23

- Improved wall review count clarity.
- Improved visual QA wall summaries.

## [0.03.017] - 2026-06-23

- Improved shared wall representation matching.
- Improved scan JSON represented-wall context.
