...
internal static class OpenPlanTraceCli
{
    ...
    private static void WriteScanUsage()
    {
        ...
        Console.WriteLine("  --svg-profile <name>      SVG overlay profile: placement-review (default), wall-qa-focus, wall-qa-review, wall-qa, structural-review, or full");
    ...
    internal static SvgOverlayRenderProfile ParseSvgOverlayProfile(string value)
    {
        ...
        throw new ArgumentException(
            $"Invalid SVG overlay profile '{value}'. Valid profiles: placement-review, wall-qa-focus, wall-qa-review, wall-qa, structural-review, full.");
    }
}
